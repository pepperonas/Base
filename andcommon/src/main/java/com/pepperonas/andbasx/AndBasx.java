...
public class AndBasx {
    ...
    private static String mLogFileName = "andcommon.log";
    ...
    public static class Version {
        ...
        /**
         * @return <p>---ANDCOMMON---<br>
         * andcommon-{@value BuildConfig#VERSION_NAME}</p>
         */
        ...
        /**
         * @return 'andcommon-{@value BuildConfig#VERSION_NAME}'
         */
        public static String versionInfo() {
            return "andcommon-" + versionName() + ".aar";
        }
