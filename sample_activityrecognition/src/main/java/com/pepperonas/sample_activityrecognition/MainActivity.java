...
public class MainActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "launches  " + AesPrefs.getLaunchCounter());

        AesPrefs.printInstallationDate();
        AesPrefs.printExecutionTime();

        Log.d(TAG, "onCreate countEntries: " + AesPrefs.countEntries());
    ...
    public void removeActivityUpdatesButtonHandler(View view) {
        ...
        ActivityRecognition.ActivityRecognitionApi.removeActivityUpdates(
                mGoogleApiClient, getActivityDetectionPendingIntent()).setResultCallback(this);
    }
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            ...
            Toast.makeText(this, getString(requestingUpdates ?
    ...
    private void setUpdatesRequestedState(boolean requestingUpdates) {
        getSharedPreferencesInstance().edit().putBoolean(
                Constants.ACTIVITY_UPDATES_REQUESTED_KEY, requestingUpdates).commit();
    }
